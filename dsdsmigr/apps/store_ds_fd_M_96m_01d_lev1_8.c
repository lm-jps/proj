/* store_ds_fd_M_96m_01d_lev1_8.c
 * 	stores mdi fd_M_96m_01d_lev1_8 ds in DRMS/SUMS.
*/
/* Usage:  store_ds_fd_M_96m_01d_lev1_8 series_num=n-m
 *         
...
char *module_name = "store_ds_fd_M_96m_01d_lev1_8";
char *series = "ds_mdi.fd_M_96m_01d_lev1_8";		  /* our series name */
...
int nice_intro()
  ...
  if (usage)
    {
    printf("store_ds_fd_M_96m_01d_lev1_8 {-h} {-v} series_num=n-m\n"
...
for(i = s_start; i <= s_end; i++) {
  sprintf(cmd,"peq 'prog:mdi,level:lev1.8,series:fd_M_96m_01d[%d]' 1> %s 2>&1", 
		i, logname);
  ...
  sprintf(fname, "%s/fd_M_96m_01d.%d.overview.fits", wd, i);
