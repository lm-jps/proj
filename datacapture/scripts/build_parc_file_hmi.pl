eval 'exec /home/jsoc/bin/$JSOC_MACHINE/perl -S $0 "$@"'
    if 0;
#/home/prodtest/cvs/JSOC/proj/datacapture/scripts/parc_update_safe_tape_hmi.pl
#
...
$sql = "select online_loc from sum_main where creat_date >= '$ldate' and owning_series='hmi.tlm' and safe_tape is NULL";
