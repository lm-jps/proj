...
#!!!NOTE this is from build_arc_to_dds_wo_offsite.pl but will use the
#Creat_date in the sum_main to match times instead of the Arch_Tape_Date.
#
...
$parchmiSAVDIR = $ARC_ROOT_HMI."SAVE";
$parcaia = $ARC_ROOT_AIA."AIA_$currdate".".arc";
$parcaiaSAVDIR = $ARC_ROOT_AIA."SAVE";
