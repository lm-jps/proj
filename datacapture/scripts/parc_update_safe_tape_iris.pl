eval 'exec /usr/local/bin/perl -d -S $0 "$@"'
    if 0;
#/home/prodtest/cvs/JSOC/proj/datacapture/scripts/parc_update_safe_tape_iris.pl
#
#This is run on the irisdc system as a cronjob every night to 
#see if there are new .parc files in /sds/soc2pipe/iris/parc.
#A .parc file entry looks like:
##owning_series_name                         tape_id  fn  date
#VC03_2013_233_06_37_26_02ce0470118_1c298_00 022382L4 1231 2013-08-22 11:53:21
#VC03_2013_233_06_37_41_02c0045e8b8_1c298_00 022382L4 1231 2013-08-22 11:53:21
#
...
sub usage {
  ...
  print "Usage: parc_update_safe_tape_iris.pl [-h] [-thrs] \n";
  print "       -h = help\n";
...
$DB = "irisdb_sums";
$PGPORT = 5434;
$DIR_PARC = "/sds/soc2pipe/iris/parc";
$HOSTDB = `hostname -s`;
chomp($HOSTDB);
...
$sql = "select online_loc from sum_main where creat_date >= '$ldate' and owning_series='iris.tlm' and safe_tape is NULL";
...
print "mv $DIR_PARC/*.parc $DIR_PARC/done";
`mv $DIR_PARC/*.parc $DIR_PARC/done`;
$dbh->disconnect();
