...
C  NAMFIL IS THE EXTERNAL NAME OF THE BINARY EPHEMERIS FILE
      ...
      NAMFIL='/home/soi/CM/tables/jpleph.403.1950-2050'
...
C  CALL STATE TO INITIALIZE THE EPHEMERIS AND READ IN THE CONSTANTS
      ...
      END
c $Id: jpleph.f,v 1.1 2008/09/02 20:01:08 arta Exp $
c $Source: /home/akoufos/Development/Testing/jsoc-4-repos-0914/JSOC-mirror/JSOC/proj/libs/astro/Attic/jpleph.f,v $
c $Author: arta $
c $Log: jpleph.f,v $
c Revision 1.1  2008/09/02 20:01:08  arta
c Add test code to getorbitinfo - checks that gci and hci values in FDS data are what we expect
c
c Revision 1.3  1998/01/31  00:54:04  kehcheng
c made it compilable by g77
c
c Revision 1.2  1996/05/01 23:09:03  jim
c from /home/schou/ephem/lib.f
c
