...
c#######################################################################
c removed old set_btype(b) subroutine
c new one defined in set_b.f
c#######################################################################
...
c#######################################################################
      subroutine get_ch_map (rv,chmap)
c
c-----------------------------------------------------------------------
c
c ****** Modified by X. Sun for JSOC
...
c
      real(r_typ) :: rv
      real(r_typ), dimension(npss,ntss), target :: chmap
c
c-----------------------------------------------------------------------
c
      real(r_typ), parameter :: one=1._r_typ
...
c
c      integer :: np_q,nt_q
      real(r_typ), dimension(npss,ntss), target :: qmap
