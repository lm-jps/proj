...
/* Non-NAN and/or physically selected pixels will be evenly assigned to each PE. Recommend 1. */
#define EQUIAREA 1
...
/* then copy it to non-constants, to avoid JSOC-compiler's complain */
  ...
  char   *indsdesc, *indsdesc2, *outser;
#if MASKPTCH == 1
  char   *indsdesc3;
#endif
  int    verbose;
...
//      if (iconverge_flag == 1) // old 
     ...
     {
      FinalConvFlagLocal[n-istart]=999; // need to be redefined ...
    ...
    {
      FinalConvFlagLocal[n-istart]=888; // need to be redefined ...
...
/* the primary PE takes care of pixels none of PE had taken care of */
  if (mpi_rank == 0)
  {
    if (istartall[0] > 0)
    {
      ...
      {
        FinalConvFlag[n] = 777; // need to be re-defined...
