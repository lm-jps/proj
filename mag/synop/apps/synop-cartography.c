...
int synop_img2sphere (double x, double y, double ang_r, double latc, double lonc,
...
int synop_plane2sphere (double x, double y, double latc, double lonc,
        double *lat, double *lon, int projection) {
/*
...
int synop_sphere2img (double lat, double lon, double latc, double lonc,
        double *x, double *y, double xcenter, double ycenter,
        double rsun, double peff, double ecc, double chi,
        int xinvrt, int yinvrt) {
/*
...
int synop_sphere2plane (double lat, double lon, double latc, double lonc,
        double *x, double *y, int projection) {
/*
