...
char *module_name = "brblosdailysynframe_nrt";
...
int DoIt(void)
{
  ...
  char *t_window = "240"; //hard-coded T-window, 240-minute window
  ...
  char *cvsinfo = strdup("$Id: brblosdailysynframe_nrt.c,v 1.3 2014/03/14 17:02:45 yliu Exp $");
...
// image statistics
    ...
    drms_setkey_double(smallRD, "BRMIN", smallstatMin);
    drms_setkey_double(smallRD, "BRMAX", smallstatMax);
    drms_setkey_double(smallRD, "BRMEDN", smallstatMedn);
    drms_setkey_double(smallRD, "BRMEAN", smallstatMean);
    drms_setkey_double(smallRD, "BRRMS", smallstatSig);
    drms_setkey_double(smallRD, "BRSKEW", smallstatSkew);
    drms_setkey_double(smallRD, "BRKURT", smallstatKurt);

  if (fstats(xout*yout, smalloutDataBlos, &smallstatMin, &smallstatMax, &smallstatMedn, &smallstatMean, &smallstatSig,
      &smallstatSkew, &smallstatKurt, &smallstatNgood)) printf("\n Statistics computation failed\n");

    drms_setkey_double(smallRD, "BLOSMIN", smallstatMin);
    drms_setkey_double(smallRD, "BLOSMAX", smallstatMax);
    drms_setkey_double(smallRD, "BLOSMEDN", smallstatMedn);
    drms_setkey_double(smallRD, "BLOSMEAN", smallstatMean);
    drms_setkey_double(smallRD, "BLOSRMS", smallstatSig);
    drms_setkey_double(smallRD, "BLOSSKEW", smallstatSkew);
    drms_setkey_double(smallRD, "BLOSKURT", smallstatKurt);
...
// writting the small size map 
    ...
    drms_setkey_string(smallRD, "BLD_VERS", jsoc_version);
    status = drms_setkey_string(smallRD, "CODEVER", cvsinfo);
...
// Blos-synoptic (second segment)
    smalloutSeg = drms_segment_lookupnum(smallRD, 1);
