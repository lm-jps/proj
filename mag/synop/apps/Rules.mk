...
MODEXE_$(d)	:= $(addprefix $(d)/, hmisynop dailysynframe dailysynframe_nrt hmisynoptic)
...
$(OBJ_$(d)):		CF_TGT := -I$(SRCDIR)/$(d)/../../../libs/astro -I$(SRCDIR)/$(d)/../../../libs/stats -I$(SRCDIR)/$(d)/src/ 
$(OBJ_$(d)):		CF_TGT := $(CF_TGT) -DCDIR="\"$(SRCDIR)/$(d)\""

$(EXTRADEPS_$(d)):	CF_TGT := $(CF_TGT) $(GSLH) -I$(SRCDIR)/$(d)
