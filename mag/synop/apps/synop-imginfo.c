...
// There were a bunch of defines and a struct here. However, these defines and the struct
// were already defined in cartography.h.
...
int synop_solar_image_info (DRMS_Record_t *img, double *xscl, double *yscl,
 ...
 * Feb-18-2016      This was modified by Yang for use with two modules (I do not know the nature of the changes). Copied and enamed to synop-imginfo.c. For use only by these two modules - ART
 */
