...
$(LIBEXRNG) $(LIBMEXTOOLS) $(METAHEADER):
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRUTIL) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRUTIL) MEXEXT=$(MEXEXT) MEX_CC=$(MEX_CC) $@
...
$(LIBMEX2C) $(LIBMEX2MATL):
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRMEX2C) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRMEX2C) MEXEXT=$(MEXEXT) CFITSIOH=$(CFITSIOH) MEX_CC=$(MEX_CC) $@
...
$(SAMEXFILES): $(METAHEADER) $(LIBEXRNG) $(LIBMEXTOOLS) $(LIBMEX2MATL)
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRSTANDALONE) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRSTANDALONE) MEXEXT=$(MEXEXT) CFITSIOH=$(CFITSIOH) MEX_CC=$(MEX_CC) $@
...
$(ASMEXFILES):
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRASSIGN) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRASSIGN) MEXEXT=$(MEXEXT) MEX_CC=$(MEX_CC) $@
...
$(FTMEXFILES):
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRFITS) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRFITS) MEXEXT=$(MEXEXT) MEX_CC=$(MEX_CC) CFITSIOH=$(CFITSIOH) $@
...
$(HMMEXFILES):
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRHMIMASK) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRHMIMASK) MEXEXT=$(MEXEXT) MEX_CC=$(MEX_CC) $@
