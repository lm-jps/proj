...
$(SAMEXFILES): $(METAHEADER) $(LIBEXRNG) $(LIBMEXTOOLS) $(LIBMEX2MATL)
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRSTANDALONE) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRSTANDALONE) MEXEXT=$(MEXEXT) CFITSIOH=$(CFITSIOH) $@
...
$(FTMEXFILES):
	$(MAKE) -C $(WORKINGDIR)/$(CSDIRFITS) OUTDIR=$(OUTDIR) CSDIR=$(CSDIRFITS) MEXEXT=$(MEXEXT) CFITSIOH=$(CFITSIOH) $@
