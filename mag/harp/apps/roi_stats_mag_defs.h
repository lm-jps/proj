...
static const char *RS_index2keyname[] = {
  ...
  "fAREA",        // RS_rgn_area    
  // extent
  "fLAT_MIN",     // RS_rgn_min_lat   
  "fLON_MIN",     // RS_rgn_min_lon	 
  "fLAT_MAX",     // RS_rgn_max_lat   
  "fLON_MAX",     // RS_rgn_max_lon	 
  // return time
  ...
  NULL,           // RS_ar_area_lat
  NULL,           // RS_ar_area_lon	 
  "fLAT_FWT",     // RS_ar_fwt_lat   
  "fLON_FWT",     // RS_ar_fwt_lon 	 
  "fLAT_FWTPOS",  // RS_ar_fwtpos_lat
  "fLON_FWTPOS",  // RS_ar_fwtpos_lon
  "fLAT_FWTNEG",  // RS_ar_fwtneg_lat
  "fLON_FWTNEG",  // RS_ar_fwtneg_lon
  // end
};
