...
extern void pdfi_wrapper4jsoc_test_(int *m, int *n, double *a, double *b, double *c, double *d,
...
int DoIt(void)
{
    ...
    c = 0.000000000000;
    d = 0.288267821074;
    tjul0 = 2455607.5582638895139098;
    tjul1 = 2455607.5749305561184883;
    ...
    pdfi_wrapper4jsoc_test_(&m, &n, &a, &b, &c, &d,
