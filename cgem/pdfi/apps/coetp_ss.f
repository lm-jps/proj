      subroutine coetp_ss(m,n,a,b,c,d,theta,phi)
c
c+
c - - Purpose:  Compute the theta and phi locations of the COE grid
c
...
c
      do i=1,m+1
         theta(i,1:n+1)=a+dble(i-1)*dtheta
      end do
c
      do j=1,n+1
         phi(1:m+1,j)=c+dble(j-1)*dphi
      end do
c
      return
      end
