...
WRAPPEDF_OBJ_$(d)    := $(addprefix $(d)/, add_padding_ss.o ahpot_ss.o berciktest_ss.o bhll2tp_ss.o bhpot_phot_ss.o bhpot_ss.o bhtp2ll_ss.o brll2tp_ss.o brpot_ss.o brtp2ll_ss.o cell_ss.o cetp_ss.o coell_ss.o coetp_ss.o coll_ss.o cotp_ss.o curl_psi_rhat_ce_ss.o curl_psi_rhat_co_ss.o curlahpot_ss.o curlh_ce_ss.o curlh_co_ss.o delh2_sc.o divh_ce_ss.o divh_co_ss.o divh_sc.o e_doppler_ss.o e_flct_ss.o e_ideal_ss.o e_ptd_ss.o ehtp2ll_ss.o enudge_ss.o ertp2ll_ss.o find_mask_ss.o gradh_ce_ss.o gradh_co_ss.o gradh_sc.o interp_data_ss.o interp_eh_ss.o interp_var_ss.o kfft.o pdfi_wrapper4jsoc_ss.o pell_ss.o petp_ss.o ptdsolve_ss.o relax_psi_3d_ss.o scrbpot_ss.o sinthta_sc.o sinthta_ss.o  tell_ss.o tetp_ss.o sr_ss.o srtot_ss.o hm_ss.o hmtot_ss.o e_voxels3d_ss.o enudge3d_ss.o)
