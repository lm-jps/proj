/*
 * HMI_observables_dconS - derive line-of-sight observables from the Stokes S records that have had scattered light removed. 
 *
 */
...
{
  return strdup("$Id: HMI_observables_dconS.c,v 1.1 2017/05/25 21:05:31 arta Exp $");
}
...
char Lev1pSegName[60][5]={"I0","Q0","U0","V0","I1","Q1","U1","V1","I2","Q2","U2","V2","I3","Q3","U3","V3","I4","Q4","U4","V4","I5","Q5","U5","V5","I6","Q6","U6","V6","I7","Q7","U7","V7","I8","Q8","U8","V8","I9","Q9","U9","V9","LCP0","RCP0","LCP1","RCP1","LCP2","RCP2","LCP3","RCP3","LCP4","RCP4","LCP5","RCP5","LCP6","RCP6","LCP7","RCP7","LCP8","RCP8","LCP9","RCP9"};   //[0,39] are the segments for IQUV data
  ...
  if(QuickLook == 1)                                                //Quick-look data
	...
	{						             
	  strcpy(HMISeriesLev15a,"hmi.V_720s_dconS"  );              
	  strcpy(HMISeriesLev15b,"hmi.M_720s_dconS" );              
	  strcpy(HMISeriesLev15c,"hmi.Ld_720s_dconS" );              
	  strcpy(HMISeriesLev15d,"hmi.Lw_720s_dconS" );              
	  strcpy(HMISeriesLev15e,"hmi.Ic_720s_dconS" );
	}
  ...
  if(QuickLook == 1)                                                //Quick-look data
  ...
  else                                                              //Final data
    {
      ...
      if( DataCadence == 720.0 && unusual == 0) strcpy(HMISeriesLev1pa,"hmi_test.S_720s_dconS");
