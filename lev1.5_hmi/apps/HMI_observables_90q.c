...
//#include "/homee/yliu/cvs/JSOC/proj/lev1.5_hmi/libs/lev15/interpol_code.h"            //from Richard's code
...
char *module_name= "HMI_observables_90q"; //name of the module
              ...
              if(ij == 1 && CAMERA == 3)
                {
                  if( (i%72)/24 == 1)
                    {
                     j=j+100000;
printf("in subroutine change i= %d, FID=%d\n", i, j);
                    }
                }
...
// -- YLiu
  ...
  if(TestLevIn[0]==1)
    ...
    {
        //status = init_polcal(&pars, method, polcalParamFile); -- YLiu
//        status = init_polcal(&pars, method, POLCAL_PARAMS); //-- YLiu
        status = init_polcal(&pars, method); //-- YLiu
        if(status != 0)
        {
  ...
  if( QuickLook == 1)                                                //Quick-look data
    {			
      ...
      if(DataCadence == 45.0)  strcpy(HMISeriesLev1d,"hmi_test.HMISeriesLev1d45Q");
      ...
      if(DataCadence == 135.0) strcpy(HMISeriesLev1d,"hmi_test.HMISeriesLev1d135Q");
  ...
  else                                                               //Final data
    {
      ...
      if(DataCadence == 45.0)  strcpy(HMISeriesLev1d,"hmi_test.HMISeriesLev1d45");
      ...
      if(DataCadence == 135.0) strcpy(HMISeriesLev1d,"hmi_test.HMISeriesLev1d135");
  ...
  if(QuickLook == 1)                                                //Quick-look data
    {			
      if(DataCadence == 45.0)
	{
	  strcpy(HMISeriesLev15a,"hmi_test.V_45s_nrt"  );              
	  strcpy(HMISeriesLev15b,"hmi_test.M_45s_nrt" );              
	  strcpy(HMISeriesLev15c,"hmi_test.Ld_45s_nrt" );              
	  strcpy(HMISeriesLev15d,"hmi_test.Lw_45s_nrt" );              
	  strcpy(HMISeriesLev15e,"hmi_test.Ic_45s_nrt" );
	}
      if(DataCadence == 22.5)
	{
      ...
      if(DataCadence == 60.0)
	{						             
	  strcpy(HMISeriesLev15a,"hmi_test.V_60s_nrt");              
	  strcpy(HMISeriesLev15b,"hmi_test.M_60s_nrt");              
	  strcpy(HMISeriesLev15c,"hmi_test.Ld_60s_nrt");              
	  strcpy(HMISeriesLev15d,"hmi_test.Lw_60s_nrt");              
	  strcpy(HMISeriesLev15e,"hmi_test.Ic_60s_nrt");
	}
      if(DataCadence == 75.0)
	{
	...
	{						             
	  strcpy(HMISeriesLev15a,"hmi_test.V_720s_nrt");              
	  strcpy(HMISeriesLev15b,"hmi_test.M_720s_nrt");              
	  strcpy(HMISeriesLev15c,"hmi_test.Ld_720s_nrt");              
	  strcpy(HMISeriesLev15d,"hmi_test.Lw_720s_nrt");              
	  strcpy(HMISeriesLev15e,"hmi_test.Ic_720s_nrt");
	}
      if(DataCadence == 720.0 && unusual == 1)//special sequence with more than 6 wavelengths
	{						             
	  strcpy(HMISeriesLev15a,"hmi_test.V2_720s_nrt");              
	  strcpy(HMISeriesLev15b,"hmi_test.M2_720s_nrt");              
	  strcpy(HMISeriesLev15c,"hmi_test.Ld2_720s_nrt");              
	  strcpy(HMISeriesLev15d,"hmi_test.Lw2_720s_nrt");              
	  strcpy(HMISeriesLev15e,"hmi_test.Ic2_720s_nrt");
	}
    }							             
  else                                                              //Final data
    {	
      if(DataCadence == 45.0)
	{						             
	  strcpy(HMISeriesLev15a,"hmi_test.V_45s");              
	  strcpy(HMISeriesLev15b,"hmi_test.M_45s" );              
	  strcpy(HMISeriesLev15c,"hmi_test.Ld_45s" );              
	  strcpy(HMISeriesLev15d,"hmi_test.Lw_45s" );              
	  strcpy(HMISeriesLev15e,"hmi_test.Ic_45s" );
	}
      if(DataCadence == 22.5)
	{
	...
	{						             
	  strcpy(HMISeriesLev15a,"hmi_test.V_135s");              
	  strcpy(HMISeriesLev15b,"hmi_test.M_135s");              
	  strcpy(HMISeriesLev15c,"hmi_test.Ld_135s");              
	  strcpy(HMISeriesLev15d,"hmi_test.Lw_135s");              
	  strcpy(HMISeriesLev15e,"hmi_test.Ic_135s");
	}
  ...
  if(QuickLook == 1)                                                //Quick-look data
    {
      ...
      if(DataCadence == 45.0) strcpy(HMISeriesLev1pb,"hmi_test.HMISeriesLev1pb45Q");
  ...
  else                                                              //Final data
    {
      ...
      if(DataCadence == 45.0) strcpy(HMISeriesLev1pb,"hmi_test.HMISeriesLev1pb45");
  ...
  if(QuickLook == 1)                                                //Quick-look data
    {
      ...
      if( DataCadence == 720.0 && unusual == 0) strcpy(HMISeriesLev1pa,"hmi_test.S_720s_nrt");
      if( DataCadence == 720.0 && unusual == 1) strcpy(HMISeriesLev1pa,"hmi_test.S2_720s_nrt");
    }
  else                                                              //Final data
    {
      if( DataCadence == 45.0)  strcpy(HMISeriesLev1pa,"hmi_test.HMISeriesLev1pa45");
      ...
      if( DataCadence == 135.0) strcpy(HMISeriesLev1pa,"hmi_test.HMISeriesLev1pa135");
      if( DataCadence == 150.0) strcpy(HMISeriesLev1pa,"su_couvidat.HMISeriesLev1pa150");
      if( DataCadence == 720.0 && unusual == 0) strcpy(HMISeriesLev1pa,"hmi_test.S_720s");
      if( DataCadence == 720.0 && unusual == 1) strcpy(HMISeriesLev1pa,"hmi_test.S2_720s");
    }
...
// -- define variable to denote Camera ID -- YLiu
          CameraID = (int *)malloc(framelistSize * sizeof(int *));
// -- YLiu
...
//--YLIU
	  for(i=0;i<framelistSize;++i) if(WavelengthIndex[i] == WavelengthID && PHWPLPOS[i*7+4] == TargetHPLPOS[0] && PHWPLPOS[i*7+5] == TargetHPLPOS[1] && PHWPLPOS[i*7+6] == TargetHPLPOS[2] && FIDValues[i] == TargetFID) temp=i; //temp is the index of WavelengthIndex corresponding to the target filtergram
...
//		  if(HWL1POS[k] != PHWPLPOS[i*7] || HWL2POS[k] != PHWPLPOS[i*7+1] || HWL3POS[k] !=  PHWPLPOS[i*7+2] || HWL4POS[k] != PHWPLPOS[i*7+3] || HPL1POS[k] != PHWPLPOS[i*7+4] || HPL2POS[k] != PHWPLPOS[i*7+5] || HPL3POS[k] !=  PHWPLPOS[i*7+6] || HCAMID[k] != camera  || CFINDEX[k] != TargetCFINDEX)   //there is an error somewhere: the filtergram we found is not what it is supposed to be!
                if(HWL1POS[k] != PHWPLPOS[i*7] || HWL2POS[k] != PHWPLPOS[i*7+1] || HWL3POS[k] !=  PHWPLPOS[i*7+2] || HWL4POS[k] != PHWPLPOS[i*7+3] || HPL1POS[k] != PHWPLPOS[i*7+4] || HPL2POS[k] != PHWPLPOS[i*7+5] || HPL3POS[k] !=  PHWPLPOS[i*7+6] || HCAMID[k] != camera  || CFINDEX[k] != TargetCFINDEX || FID[k] != fidfilt) // YLIU  
//there is an error somewhere: the filtergram we found is not what it is supposed to be!
		      ...
		      for(ii=1;ii<framelistSize;++ii)
			{
			  if(OrganizeFramelist[i] > 0) //we look for filtergrams AFTER the target filtergram
				...
				{
				  if(HWL1POS[k] == PHWPLPOS[i*7] && HWL2POS[k] == PHWPLPOS[i*7+1] && HWL3POS[k] ==  PHWPLPOS[i*7+2] && HWL4POS[k] == PHWPLPOS[i*7+3] && HPL1POS[k] == PHWPLPOS[i*7+4] && HPL2POS[k] == PHWPLPOS[i*7+5] && HPL3POS[k] ==  PHWPLPOS[i*7+6] && HCAMID[k] == camera  && CFINDEX[k] == TargetCFINDEX && FID[k] == fidfilt) break; // YLIU
//                                  if(HWL1POS[k] == PHWPLPOS[i*7] && HWL2POS[k] == PHWPLPOS[i*7+1] && HWL3POS[k] ==  PHWPLPOS[i*7+2] && HWL4POS[k] == PHWPLPOS[i*7+3] && HPL1POS[k] == PHWPLPOS[i*7+4] && HPL2POS[k] == PHWPLPOS[i*7+5] && HPL3POS[k] ==  PHWPLPOS[i*7+6] && HCAMID[k] == camera  && CFINDEX[k] == TargetCFINDEX) break; // YLIU
				}
			    }
...
//                              if(HWL1POS[k] == PHWPLPOS[i*7] && HWL2POS[k] == PHWPLPOS[i*7+1] && HWL3POS[k] ==  PHWPLPOS[i*7+2] && HWL4POS[k] == PHWPLPOS[i*7+3] && HPL1POS[k] == PHWPLPOS[i*7+4] && HPL2POS[k] == PHWPLPOS[i*7+5] && HPL3POS[k] ==  PHWPLPOS[i*7+6] && HCAMID[k] == camera && CFINDEX[k] == TargetCFINDEX && (internTOBS[k]-TargetTime) >= -MaxSearchDistanceL)
			      if(HWL1POS[k] == PHWPLPOS[i*7] && HWL2POS[k] == PHWPLPOS[i*7+1] && HWL3POS[k] ==  PHWPLPOS[i*7+2] && HWL4POS[k] == PHWPLPOS[i*7+3] && HPL1POS[k] == PHWPLPOS[i*7+4] && HPL2POS[k] == PHWPLPOS[i*7+5] && HPL3POS[k] ==  PHWPLPOS[i*7+6] && HCAMID[k] == camera && CFINDEX[k] == TargetCFINDEX && (internTOBS[k]-TargetTime) >= -MaxSearchDistanceL && FID[k] == fidfilt) // YLIU
				{
...
//                              if(HWL1POS[k] == PHWPLPOS[i*7] && HWL2POS[k] == PHWPLPOS[i*7+1] && HWL3POS[k] ==  PHWPLPOS[i*7+2] && HWL4POS[k] == PHWPLPOS[i*7+3] && HPL1POS[k] == PHWPLPOS[i*7+4] && HPL2POS[k] == PHWPLPOS[i*7+5] && HPL3POS[k] ==  PHWPLPOS[i*7+6] && HCAMID[k] == camera && CFINDEX[k] == TargetCFINDEX && (internTOBS[k]-TargetTime) <= MaxSearchDistanceR)
			      if(HWL1POS[k] == PHWPLPOS[i*7] && HWL2POS[k] == PHWPLPOS[i*7+1] && HWL3POS[k] ==  PHWPLPOS[i*7+2] && HWL4POS[k] == PHWPLPOS[i*7+3] && HPL1POS[k] == PHWPLPOS[i*7+4] && HPL2POS[k] == PHWPLPOS[i*7+5] && HPL3POS[k] ==  PHWPLPOS[i*7+6] && HCAMID[k] == camera && CFINDEX[k] == TargetCFINDEX && (internTOBS[k]-TargetTime) <= MaxSearchDistanceR && FID[k] == fidfilt) // YLIU
				{
				  FramelistArray[i+framelistSize*ii]=k;
				}
			      else  FramelistArray[i+framelistSize*ii]=-1; //do not use filtergram
...
// -- denote Camera ID for this filtergram -- YLiu
...
// -- save camera ID for this polarization -- YLiu
            CameraID [k] = CamID_tmp;
...
// -- calculate I-ratio at wavelength = k -- YLiu
// -- Define I-camera1, I-camera2, for I-scale computation -- YLiu
          int Ixdim, Iydim;
          float *Icamera_FRONT, *Icamera_SIDE, *Iratio_F2S, I_front, I_side;
          int Ncamera_FRONT, Ncamera_SIDE, ix, jy, ijxy;
          Ixdim = 4096; Iydim = 4096; Ncamera_FRONT = 0; Ncamera_SIDE = 0;
          Icamera_FRONT = (float *)malloc(Ixdim * Iydim * sizeof(float *));
          Icamera_SIDE = (float *)malloc(Ixdim * Iydim * sizeof(float *));
          Iratio_F2S = (float *)malloc(Ixdim * Iydim * sizeof(float *));
          ...
          for (jy=0;jy<Iydim;jy++)
          {
            ...
            {
                ijxy = jy*Ixdim+ix;
                Icamera_FRONT[ijxy] = 0.0;
                Icamera_SIDE[ijxy] = 0.0;
                Iratio_F2S[ijxy] = 1.0;
            }
          }
// -- End of definition -- YLiu

// -- calculate I-average for camera 1 and 2
          if (combine == 1)
          {
              for(ii=0;ii<nRecs1d;++ii) if (WhichWavelength(fid[ii]) == k)       //find out which images have the wavelength k
                 {
                      image=arrLev1d[ii]->data;               
                      if (CameraID[ii] == LIGHT_FRONT)
                       {
                           Ncamera_FRONT += 1;
                           for (jy=0;jy<Iydim;jy++)
                             {
                             for (ix=0;ix<Ixdim;ix++)
                               {
                                 ijxy = jy*Ixdim+ix;
                                 Icamera_FRONT[ijxy] += image[ijxy];
                               }
                             }
                        }
                       if (CameraID[ii] == LIGHT_SIDE)
                        {
                            Ncamera_SIDE += 1;
                            for (jy=0;jy<Iydim;jy++)
                              {
                    ...
                    for (jy=0;jy<Iydim;jy++)
                      {
                         for (ix=0;ix<Ixdim;ix++)
                           {
                              ijxy = jy*Ixdim+ix;
                              if (!isnan(Icamera_FRONT[ijxy]) && !isnan(Icamera_SIDE[ijxy]))
                              I_front = Icamera_FRONT[ijxy]/(float)Ncamera_FRONT;
                              I_side = Icamera_SIDE[ijxy]/(float)Ncamera_SIDE;
                              Iratio_F2S[ijxy] = I_front/I_side;
                           }
                       }
              }
              free(Icamera_FRONT);
              free(Icamera_SIDE);
//-- end of I-ratio calculation -- YLiu
...
// -- start rescale I-filtergrams from Front Camera  by dividing Iratio (keep Q U untarched because previously we use Side camera data: keep data consistent) -- YLiu

                if (combine == 1 && CameraID[ii] == LIGHT_FRONT)
                 {
                   image = arrLev1d[ii]->data;
                   for (jy=0;jy<Iydim;jy++)
                    {
...
// -- end of I-scaling side camera images -- YLiu
