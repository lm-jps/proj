/*
 * HMI_observables_dcon2 - derive line-of-sight observables from the HMI level 1 records that have had scattered light removed.  However, this code specifically uses the level 1 records with scattered light removal performed by KehCheng's c code (as opposed to the cuda-c code.) 
 *
 */
...
char Lev1pSegName[60][5]={"I0","Q0","U0","V0","I1","Q1","U1","V1","I2","Q2","U2","V2","I3","Q3","U3","V3","I4","Q4","U4","V4","I5","Q5","U5","V5","I6","Q6","U6","V6","I7","Q7","U7","V7","I8","Q8","U8","V8","I9","Q9","U9","V9","LCP0","RCP0","LCP1","RCP1","LCP2","RCP2","LCP3","RCP3","LCP4","RCP4","LCP5","RCP5","LCP6","RCP6","LCP7","RCP7","LCP8","RCP8","LCP9","RCP9"};   //[0,39] are the segments for IQUV data
  ...
  if(QuickLook == 1)                                                //Quick-look data
    ...
    {	
      if(DataCadence == 45.0)
	{						             
	  strcpy(HMISeriesLev15a,"hmi.V_45s_dcon");              
	  strcpy(HMISeriesLev15b,"hmi.M_45s_dcon" );              
	  strcpy(HMISeriesLev15c,"hmi.Ld_45s_dcon" );              
	  strcpy(HMISeriesLev15d,"hmi.Lw_45s_dcon" );              
	  strcpy(HMISeriesLev15e,"hmi.Ic_45s_dcon" );
	}
      if(DataCadence == 22.5)
	{
