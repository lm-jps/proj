...
DEFMAKE_$(d)	:= $(addprefix $(d)/, HMI_observables HMI_IQUV_averaging correction_velocities ingest_dcon ingest_dcon_gen HMI_observables_dcon HMI_observables_dcon2 HMI_observables_dconS lev1_dcon HMI_IQUV_averaging_dcon HMI_observables_135q)
