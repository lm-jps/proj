...
DEFMAKE_$(d)	:= $(addprefix $(d)/, HMI_observables HMI_IQUV_averaging correction_velocities phasemaps_voigt ingest_dcon HMI_observables_dcon HMI_observables_dcon2 lev1_dcon HMI_IQUV_averaging_dcon)
