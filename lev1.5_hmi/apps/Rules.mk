...
<<<<<<< Rules.mk
DEFMAKE_$(d)	:= $(addprefix $(d)/, HMI_observables_90q HMI_observables HMI_IQUV_averaging_YL HMI_IQUV_averaging correction_velocities ingest_dcon ingest_dcon_gen HMI_observables_dcon HMI_observables_dcon2 lev1_dcon HMI_IQUV_averaging_dcon HMI_observables_135q)
=======
DEFMAKE_$(d)	:= $(addprefix $(d)/, HMI_observables_90q HMI_observables HMI_IQUV_averaging correction_velocities ingest_dcon ingest_dcon_gen HMI_observables_dcon HMI_observables_dcon2 HMI_observables_dconS lev1_dcon HMI_IQUV_averaging_dcon HMI_observables_135q stokes_dcon)
>>>>>>> 1.29
