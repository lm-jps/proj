/*
 * HMI_observables_dcon - derive line-of-sight observables from the HMI level 1 records that have had scattered light removed. 
 *
 */
...
{
  return strdup("$Id: HMI_observables_dcon.c,v 1.5 2016/10/03 17:43:52 arta Exp $");
}
