#!/usr/bin/perl
#/home/prodtest/cvs/JSOC/proj/lev0/scripts/rsync_irisdc_jsoc.pl
#
#Usage: rsync_irisdc_jsoc.pl [log_file]
#where log_file is an optional file to store the output log.
#      If none is given then the log goes to
#      /tmp/rsync_irisdc_YYYY.MM.DD_HH:MM:SS.log
#
#rsync's irisdc:/home/prodtest/cvs/JSOC to sunroom:/home/prodtest/irisdc_backup
#
#
#Typically this is run as a user prodtest cron job like so:
#30 18 * * * /home/prodtest/cvs/JSOC/proj/lev0/scripts/rsync_irisdc_jsoc.pl
#
...
if($#ARGV == -1) {
  $label = &labeldate;
  $logfile = "/tmp/rsync_irisdc_".$label;
}
else {
  $logfile = $ARGV[0];
}
...
$cmd = "/usr/bin/rsync --rsh=/usr/bin/ssh --rsync-path=/usr/bin/rsync -avz /home/prodtest/cvs/JSOC sunroom:/home/prodtest/irisdc_backup";
...
#$cmd = "source $sshfilesource; /usr/bin/rsync --rsh=/usr/bin/ssh --rsync-path=/usr/bin/rsync -avz /srv/www d00:/home/production/dcs1_backup";
