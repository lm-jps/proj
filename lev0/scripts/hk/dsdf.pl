...
#              system.                                                       #
# Execution:   dsdf.pl < rtmon | moc >                                       #
#              dsdf.pl -h                                                    #
# Examples:    dsdf.pl moc                                                   #
# Examples:    dsdf.pl rtmon                                                 #
...
elsif ( $source == "hsb" ) 
{
  ...
  print "ERROR: note hsb is not implemented in dsdf.pl yet!\n";
  exit;
}
else 
{
...
elsif ($source eq "rtmon")
{
  ...
  #print  "dsdf.pl:LIST HKT: @list_hkt_files\n";
  #print  "dsdf.pl:LIST XML: @list_xml_files\n";
}
else
{
  print "ERROR: Unknown source value:<$source>. Exiting script dsdf.pl!\n";
  exit;
}
