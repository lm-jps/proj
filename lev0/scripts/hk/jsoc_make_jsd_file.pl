...
# Example:     jsoc_make_jsd_file.pl prelim 1.79                             #
# Example:     jsoc_make_jsd_file.pl final  1.79                             #
# Author:      Carl                                                          #
...
if ( $ARGV[0] eq "-h" )
{
  ...
  print "(1a)Create Preliminary JSD Files: jsoc_make_jsd_file.pl prelim <File Version Number>\n";
  print "(1a)Create Final JSD Files:       jsoc_make_jsd_file.pl final <File Version Number>\n";
  print "(1b)Get Help Information:         jsoc_make_jsd_file.pl -h \n";
