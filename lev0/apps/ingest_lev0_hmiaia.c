/*-----------------------------------------------------------------------------
 * cvs/JSOC/proj/lev0/apps/ingest_lev0_hmiaia.c
 * NOTE: This originally came from ingest_lev0.c running on cl1n001
 *-----------------------------------------------------------------------------
 *
 ...
 * Run on data capture for working w/JSOC backend (e.g. cl1n001):
 * ingest_lev0_hmiaia vc=VC05 indir=/dds/soc2soc/hmi outdir=/dds/soc2pipe/hmi pipedir=/dds/pipe2soc/hmi [logfile=name]
 ...
 * ingest_lev0_hmiaia vc=VC05 indir=/dds/soc2pipe/hmi [logfile=name]
 *
 * OPERATION:
