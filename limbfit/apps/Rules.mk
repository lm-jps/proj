...
MODEXE_USEF 		:= $(MODEXE_USEF) $(MODEXE_USEF_$(d)) $(MODEXE_USEF_TAS_$(d)) $(MODEXE_USEF_TAS512_$(d)) $(MODEXE_USEF_TAS1024_$(d))
MODEXE			:= $(MODEXE) $(MODEXE_ANN_$(d))

OBJ_$(d)		:= $(MODEXE_USEF_$(d):%=%.o) $(MODEXE_USEF_TAS_$(d):%=%.o) $(MODEXE_USEF_TAS512_$(d):%=%.o) $(MODEXE_USEF_TAS1024_$(d):%=%.o) $(MODEXE_ANN_$(d):%=%.o) $(SUPPOBJ_$(d)) $(SUPPOBJ_TAS_$(d)) $(SUPPOBJ_TAS512_$(d)) $(SUPPOBJ_TAS1024_$(d)) $(SUPPOBJ_ANN_$(d)) $(SUPPOBJ_COMM_$(d)) 
...
TGT_BIN	 	       	:= $(TGT_BIN) $(MODEXE_USEF_$(d)) $(MODEXE_USEF_TAS_$(d)) $(MODEXE_USEF_TAS512_$(d)) $(MODEXE_USEF_TAS1024_$(d)) $(MODEXE_ANN_$(d))
S_$(d)			:= $(notdir $(MODEXE_USEF_$(d)) $(MODEXE_USEF_TAS_$(d)) $(MODEXE_USEF_TAS512_$(d)) $(MODEXE_USEF_TAS1024_$(d)) $(MODEXE_ANN_$(d)))
