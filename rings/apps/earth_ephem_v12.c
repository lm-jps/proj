/*
 *  earth_ephem.c			(to be linked from) ~rick/src/mtrack
 *
 *  Library of functions for determining geocentric ephemeris of time from
 *    JPL ephemeris
 *
 *  hc_earth_ephem()
 *  earth_ephemeris()
 *  earth_meridian_crossing()
 *
 ...
 *	rings/hmi/selstuff_v10.c
 *	rings/hmi/rdcover v 1.4
 *
 */
 ...
 *  21.11.04	Require specific version of jpleph
 *  v 1.2 frozen 2021.11.05
 */
