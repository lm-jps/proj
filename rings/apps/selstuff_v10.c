 ...
 *    modules or programs under /home/rick/src/:
 *	rings/hmi/maicalc.c
 *	  key_params_from_dspec			v 2.5
 *	    (unversioned "version" in v 0.7 - 2.4)
 *
 *  Revision history is at end of file
 */
 
#define SELSTUFF_VERSION_NUM	(1.0)
...
DRMS_RecordSet_t *select_dataset_from_time_interval (const char *series,
    const char *key, char *tmid_str, double intrvl) {
/*
 ...
 *		select_dataset_from_time_interval
 *  16.09.22 (unnumbered) version 0 (selstuff_0.c frozen)
 *			added define of included code version
 *  21.11.03	Added version control for included ephemeris code
 *  v 1.0 frozen 2012.11.05
 *
 */
